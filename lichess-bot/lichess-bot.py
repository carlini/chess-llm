...
def handle_challenge(event: EVENT_TYPE, li: lichess.Lichess, challenge_queue: MULTIPROCESSING_LIST_TYPE,
    ...
    if is_supported:
        ...
        li.decline_challenge(chlng.id, reason="tooSlow" if decline_reason == "timeControl" else decline_reason)
...
def say_hello(conversation: Conversation, hello: str, hello_spectators: str, board: chess.Board) -> None:
    ...
    if len(board.move_stack) < 2:
        ...
        #conversation.send_message("player", "For more information see https://nicholas.carlini.com/writing/2023/chess-llm.html")
        #conversation.send_message("spectator", "For more information see https://nicholas.carlini.com/writing/2023/chess-llm.html")
